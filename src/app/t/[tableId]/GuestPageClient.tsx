                      ...
                      <Card key={item.id} className={`w-full min-w-0 overflow-hidden border-border/40 bg-card/50 backdrop-blur-sm shadow-sm hover:border-primary/30 transition-colors ${isInCart ? 'border-primary/50 bg-primary/5 shadow-primary/10' : ''}`}>
                        <div className="p-3 flex flex-row gap-3">
                          ...
                          <div className="flex-1 flex flex-col gap-1.5 min-w-0">
                            ...
                            {isInCart && (
                              <div className="mt-1">
                                <Badge className="bg-primary/10 text-primary/90 border-none rounded-full px-2.5 py-0.5 text-[11px] font-medium hover:bg-primary/15">
                                  В корзине: {cartQuantity}
                                </Badge>
                              </div>
                            )}
                          ...
                          <div className="flex flex-col items-end justify-between min-w-[90px] pl-2 border-l border-border/10">
                            <span className="font-semibold text-primary whitespace-nowrap">{item.price} ₽</span>

                            <div className="mt-auto pt-2">
                              {plainCartQuantity > 0 ? (
                                <div className="flex items-center gap-1.5 rounded-full border border-primary/30 bg-primary/10 p-0.5">
                                  <Button
                                    variant="ghost"
                                    size="icon"
                                  ...
                                  <span className="min-w-5 text-center text-xs font-semibold text-primary">{plainCartQuantity}</span>
                                  <Button
                                    variant="ghost"
                                    size="icon"
                                    className="h-7 w-7 rounded-full text-primary hover:bg-background"
                                ...
                                <Button
                                  size="sm"
                                  variant="outline"
                                  className="border-border/50 bg-transparent hover:bg-primary/10 hover:text-primary hover:border-primary/30 rounded-full px-4 h-8 text-xs"
                                  onClick={() => addToCart(item)}
                                >
                                  Добавить
                                </Button>
